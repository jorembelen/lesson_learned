        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="form-horizontal form-disabled-button"  method="POST" action="{{ route('lessons.store') }}" id="lesson-create" enctype="multipart/form-data">
                   ...
                   <div class="row mb-4">
                    <label for="horizontal-email-input" class="col-sm-3 col-form-label">Attach Images</label>
                    <div class="col-sm-6">
                ...
                <div class="row mb-4">
                    <label for="horizontal-email-input" class="col-sm-3 col-form-label">Attach File</label>
                    <div class="col-sm-9">
